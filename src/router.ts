...
import {Type, isBlank, isPresent} from '@angular/router/src/facade/lang';
import {ListWrapper} from '@angular/router/src/facade/collection';
import {EventEmitter, Observable, PromiseWrapper, ObservableWrapper} from '@angular/router/src/facade/async';
import {StringMapWrapper} from '@angular/router/src/facade/collection';
import {BaseException} from '@angular/core';
import {RouterUrlSerializer} from '@angular/router/src/router_url_serializer';
import {CanDeactivate} from '@angular/router/src/interfaces';
import {recognize} from '@angular/router/src/recognize';
import {Location} from '@angular/common';
import {link} from '@angular/router/src/link';
...
} from '@angular/router/src/segments';
import {hasLifecycleHook} from '@angular/router/src/lifecycle_reflector';
